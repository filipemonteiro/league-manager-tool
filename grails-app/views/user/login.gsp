...
<html>
    <head>
        ...
        <g:set var="entityName" value="League Manager Login" />
        <title><g:message code="League Manager Login" args="[entityName]" /></title>
    </head>
    <body>
        ...
        <div id="create-user" class="content scaffold-create" role="main">
            <h1><g:message code="LeagueManager Login" /></h1>
